...
import { FaLinkedin } from 'react-icons/fa'
 ...
 const About = () => {
  return (
    ...
    <div className='flex w-full items-stretch flex-col max-w-7xl md:flex-row gap-30 mt-20'>
    ...
    <h1 className='uppercase tracking-wide font-bold text-3xl text-cyan-300 mt-5 '>subhashini</h1>
      ...
      <div className='flex mt-8 gap-6 '>
        <a href=""><FaLinkedin className='w-7 h-7 text-cyan-400/70 hover:text-cyan-200 hover:scale-110 transistion duration-300'/></a>
        <a href=""><FaGithub className='w-7 h-7 text-cyan-400/70 hover:text-cyan-200 hover:scale-110 transistion duration-300'/></a>
        <a href=""><HiOutlineMail className='w-7 h-7  text-cyan-400/70 hover:text-cyan-200 hover:scale-110 transistion duration-300'/></a>
      </div>
    </div>

    <div className='relative text-cyan-200 w-full max-w-3xl h-90 border border-cyan-500/25 shadow-[0_0_40px_rgba(15,23,42,0.9),0_0_70px_rgba(34,211,238,0.15)] bg-[#02040f]/80 backdrop-blur rounded-md flex flex-col'>hii
