...
const Navbar = () => {
  ...
  return (
    <nav className='border fixed w-full top-0 z-50 border-white/10 shadow-md backdrop-blur-sm font-semibold'>
        <div className='flex justify-between md:px-20 px-5  py-5 mx-auto text-white'>
            ...
            <ul className='hidden md:flex gap-3 pt-5 uppercase tracking-[0.05em]'>
                ...
                <li><a href="https://docs.google.com/document/d/1F18u3pkhrbs7inhJvOWkw6EjNCqQX4Wk/edit?usp=sharing&ouid=111966828785813219905&rtpof=true&sd=true"
                 className='hover:bg-red-800 px-5 py-2 rounded-full drop-shadow-[0_0px_10px_rgba(220,38,38,1)] transition'>Resume</a></li>
            ...
            {open &&(
              <ul className='md:hidden space-y-3 px-5 pb-4 uppercase font-bold tracking-[0.05em] text-white'>
                ...
                <li><a href="https://docs.google.com/document/d/1F18u3pkhrbs7inhJvOWkw6EjNCqQX4Wk/edit?usp=sharing&ouid=111966828785813219905&rtpof=true&sd=true" onClick={()=>setopen(false)}>Resume</a></li>
